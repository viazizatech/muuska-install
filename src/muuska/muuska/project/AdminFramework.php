...
class AdminFramework extends AbstractSubProject implements ControllerPageFormatingListener
{
    ...
    public function createController(\muuska\controller\ControllerInput $input) {
        ...
        }elseif($input->checkName(Names::LOGOUT_CONTROLLER)){
            $result = new \muuska\controller\admin\LogoutAdminController($input);
        }elseif($input->checkName(Names::LOGIN_CONTROLLER)){
            $result = new \muuska\controller\admin\LoginAdminController($input);
        }elseif($input->checkName(Names::REGISTER_CONTROLLER)){
            $result = new \muuska\controller\admin\RegisterAdminController($input);
        }elseif($input->checkName(Names::EMAIL_VERIFICATION_CONTROLLER)){
            $result = new \muuska\controller\admin\EmailVerificationAdminController($input);
